        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              return _context3.abrupt('return', res.status(404).send({ 'message': 'category not found' }));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              return _context4.abrupt('return', res.status(404).send({ 'message': 'category not found' }));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              return _context5.abrupt('return', res.status(404).send({ 'message': 'category not found' }));
